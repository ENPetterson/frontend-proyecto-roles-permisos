...
const model = ref([
    {
        label: 'Admin',
        items: [{ label: 'Administrador', icon: 'pi pi-fw pi-home', to: '/admin' }, { label: 'Perfil', icon: 'pi pi-fw pi-home', to: '/admin/perfil' }]
    },
    {
        label: 'Gestion Roles y Permisos',
        items: [
            { label: 'Usuarios', icon: 'pi pi-fw pi-id-card', to: '/admin/usuario' },
            { label: 'Roles', icon: 'pi pi-fw pi-lock', to: '/admin/role' },
